...
class Messages {
  ...
  BuildingMessages get building => BuildingMessages(this);
  CustomerMessages get customer => CustomerMessages(this);
  TasksCardMessages get tasksCard => TasksCardMessages(this);
  ItemsMessages get items => ItemsMessages(this);
  OntMessages get ont => OntMessages(this);
  CatvMessages get catv => CatvMessages(this);
  TaskMessages get task => TaskMessages(this);
...
class OntMessages {
  final Messages _parent;
  const OntMessages(this._parent);
